...
const {IntonationModule} = NativeModules;
...
const App = () => {
  ...
  const changeToAlein = () => {
    Platform.OS === 'android'
      ? IntonationModule.changeVoiceToAlien(audioTrackURL)
      : IntonationModule.changeVoiceToAlien();
  };

  const changeToChild = () => {
    Platform.OS === 'android'
      ? IntonationModule.changeVoiceToChild(audioTrackURL)
      : IntonationModule.changeVoiceToChild();
  };

  const changeToFast = () => {
    Platform.OS === 'android'
      ? IntonationModule.speedUpVoice(audioTrackURL)
      : IntonationModule.speedUpVoice();
  };

  const changeToSlow = () => {
    Platform.OS === 'android'
      ? IntonationModule.slowDownVoice(audioTrackURL)
      : IntonationModule.slowDownVoice();
  };
